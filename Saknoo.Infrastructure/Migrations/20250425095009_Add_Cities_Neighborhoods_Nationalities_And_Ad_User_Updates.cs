...
{
    /// <inheritdoc />
    public partial class Add_Cities_Neighborhoods_Nationalities_And_Ad_User_Updates : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceFrom = table.Column<int>(type: "int", nullable: true),
                    PriceTo = table.Column<int>(type: "int", nullable: true),
                    HasApartment = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeighborhoodId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdNeighborhood", x => new { x.AdId, x.NeighborhoodId });
                    table.ForeignKey(
                        name: "FK_AdNeighborhood_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdNeighborhood_Neighborhoods_NeighborhoodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdNeighborhood_NeighborhoodId",
